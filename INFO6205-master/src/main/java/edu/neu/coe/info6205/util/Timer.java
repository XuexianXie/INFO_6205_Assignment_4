...
//            	System.out.print("_---------------ticks: "+ ticks+" \n");
            	resume();
//            	System.out.println("sup: "+supplier.get());
        		U u = function.apply(supplier.get());
//        		System.out.println("sup1: "+supplier.get());
        		pauseAndLap();
...
//        	pause();
    ...
    public double meanLapTime() {
        ...
        double x = toMillisecs(ticks) / laps;
//        System.out.println("ticks: "+ ticks);
//        System.out.println("laps: "+ laps);
//        System.out.println("toMillisecs: "+ x);
        return x;
    }
